          ...
          <div className='product-single-content bg-white grid'>
            ...
            <div className='product-single-r'>
              <div className='product-details font-manrope'>
                ...
                {isAuthenticated && <div className='qty flex align-center my-4'>
                ...
                <div className='btns'>
                  {isAuthenticated && <button type = "button" className='add-to-cart-btn btn'>
                    <i className='fas fa-shopping-cart'></i>
                    <span className='btn-text mx-2' onClick={() => { addToCartHandler(product)}}>add to cart</span>
                  </button>}
                  {isAuthenticated && <button type = "button" className='buy-now btn mx-3'>
